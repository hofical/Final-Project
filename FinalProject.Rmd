...
ggplot(fast_food_percent, aes(x = vitamins, y = fiber_perc, color = healthy)) + geom_point() + geom_jitter(height = 0.1, width  = 0.1) + scale_color_viridis_d()
...
ggplot(low_all_food, aes(x = restaurant)) + geom_bar()

ggplot(low_all_food, aes(x = calories, y = vitamins, color = restaurant)) + geom_point() + geom_text(aes(label= ifelse(calories>=200 & vitamins >= 0.15, item, "")))
