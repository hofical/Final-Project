...
After checking these datapoints it seems that there is no mechanical reason to exclude these points from the analysis. Their values do not seem to be typos, out of range or sampling errors so I will not remove them from the dataset.
